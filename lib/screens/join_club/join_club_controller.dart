...
//   ///page two
//   final Rx<TextEditingController> mMemberNameController = TextEditingController().obs;
//   final TextEditingController mCompanyNameController = TextEditingController();
//   final Rx<TextEditingController> mMobilePhoneController = TextEditingController().obs;
//   final TextEditingController mMemberPassportController =
//       TextEditingController();
//   final Rx<TextEditingController> mEmailController = TextEditingController().obs;
...
//         clubId.value =
//             (mJoinClubResponse.data?.clubs?.first.id ?? "").toString();
...
//         sJoinClubMembership.value
//             .addAll(mJoinClubResponse.data?.clubsMembership ?? []);
//       }

//       ///event list
//       // mEventList.value.clear();
//       // mEventList.value.addAll(mEventResponse.data?.module ?? []);
//       // intEventCount.value = mEventList.value.length;
//     }
//   }
...
//         // DateTime sDate =
//         //     DateFormat("dd-MM-yyyy").parse(mPaymentDateController.value.text);
//         // String value =
...
//             await AllApiImpl().postJoinClubSubmit(mJoinClubSubmitRequest);
//         if (mWebResponseSuccess.statusCode == WebConstants.statusCode200) {
//           JoinClubSubmitResponse mJoinClubSubmitResponse =
//               mWebResponseSuccess.data;
//           if (mJoinClubSubmitResponse.statusCode ==
//               WebConstants.statusCode200) {
//             // SideMenuDrawerModel controller = Get.find();
//             // controller.isJoinClub.value = false;

//             getProfile();
//             AppAlert.showSnackBar(
//                 Get.context!, mJoinClubSubmitResponse.data?.message ?? "");
//           } else {
//             AppAlert.showSnackBar(
//                 Get.context!, mJoinClubSubmitResponse.data?.message ?? "");
//           }
...
//           Get.offNamed(RouteConstants.rDashboardScreen);
//         }
//       } else {
//         AppAlert.showSnackBar(
//             Get.context!, MessageConstants.noInternetConnection);
